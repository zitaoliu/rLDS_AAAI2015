...
[Vpred, VpredEigVecs, VpredEigVals ] = psdProjection(Vpred);

VpredInv = psdInverse( VpredEigVecs, VpredEigVals );

J = (Vfilt * A') * VpredInv; % smoother gain matrix
xsmooth = xfilt + J*(xsmooth_future - xpred);
Vsmooth = Vfilt + J*(Vsmooth_future - Vpred)*J';

[Vfilt_future, Vfilt_futureEigVecs, Vfilt_futureEigVals] = ...
    psdProjection(Vfilt_future);

Vfilt_futureInv = psdInverse(Vfilt_futureEigVecs, Vfilt_futureEigVals);

VVsmooth_future = VVfilt_future + (Vsmooth_future - Vfilt_future) ...
    * Vfilt_futureInv * VVfilt_future;
