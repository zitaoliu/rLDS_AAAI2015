function [bestA, bestC, bestQ, bestR, bestInitx, bestInitV, LL, QFuncVals] = ...
    learn_kalman(data, A, C, Q, R, initx, initV, max_iter, diagQ, diagR, ...
    ARmode, constr_fun, varargin)
...
while ~converged && (num_iter <= max_iter)
    ...
    [gamma, gammaEigVecs, gammaEigVals] = psdProjection(gamma);
    ...
    % compute Q function value
    qFuncVal = computeQFuncVal( A, C, Q, R, initV, gamma1, beta, gamma2, ...
        Tsum1, gamma, delta, alpha, Tsum, 0, 0, L, detQ);
    
    QFuncVals = [QFuncVals qFuncVal];
